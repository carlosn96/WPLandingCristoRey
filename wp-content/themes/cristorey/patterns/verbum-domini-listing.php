 ...
 * Description: A premium listing for daily reflections and Verbum Domini posts.
 */
?>
...
<div class="wp-block-group alignwide"
    ...
    <h2 class="wp-block-heading has-text-align-center" style="font-style:normal;font-weight:700">Verbum Domini</h2>
    <!-- /wp:heading -->

    <!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"1.2rem","fontStyle":"italic"}}} -->
    <p class="has-text-align-center" style="font-size:1.2rem;font-style:italic">Meditaciones diarias para nutrir el
        espíritu.</p>
    <!-- /wp:paragraph -->
